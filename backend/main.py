...
def get_emotion_stats():
    """
    Thống kê cải tiến:
    1. Dữ liệu MỚI: Gom theo ID người thật.
    2. Dữ liệu CŨ: Cứ 5 câu trả lời liên tiếp -> Gom thành 1 người giả định.
    """
    try:
        ...
        # Biến đếm riêng cho dữ liệu cũ để gom nhóm
        old_data_count = 0 
        ...
        for item in data:
            ...
            if sub_id:
                ...
                # === DỮ LIỆU CŨ (Không ID) ===
                # Logic mới: Dùng phép chia lấy nguyên (//) cho 5
                # Ví dụ: Dòng 0,1,2,3,4 -> (i // 5) đều bằng 0 -> Gom vào người 'anon_0'
                #        Dòng 5,6,7,8,9 -> (i // 5) đều bằng 1 -> Gom vào người 'anon_1'
                
                fake_user_index = old_data_count // 5  # <--- PHÉP THUẬT NẰM Ở ĐÂY
                ...
                old_data_count += 1 # Tăng biến đếm
